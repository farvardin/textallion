Version 11/131229 of French by Eric Forgeot begins here.
...
Use French.
[We use this so we can check in extension if French.i7x is active, like this: "if the French option is active..."]
...
To say genre du joueur:
	say "[if Player is female]elle[otherwise]il[end if]".
	
	
[utilisé pour : vous pouvez voir etc...]
To say personne du joueur:
	say "[if the French 3PSPa Language option is active or the French 3PSPr Language option is active][genre du joueur][otherwise if the French Language option is active]vous[otherwise]je[end if]". 


To say genre du joueur en capital:
	say "[if Player is female]Elle[otherwise]Il[end if]"

To say personne du joueur en capital: [I don't use ''in title case'' because it takes too much memory just for this...]
	say "[if the French 3PSPa Language option is active or the French 3PSPr Language option is active][genre du joueur en capital][otherwise if the French Language option is active]Vous[otherwise]Je[end if]". 
...
Use FEMALEPLAYER translates as (- Constant FEMALEPLAYER; -).
...
The description of yourself is 
		"[if the French 3PSPa Language option is active][genre du joueur en capital] était comme d'habitude.
		[otherwise if the French 3PSPr Language option is active][genre du joueur en capital] est comme d'habitude.
...
Understand the command "écouter" as "ecouter".
...
Carry out rubbing it with:
	say "[if the French 3PSPa Language option is active][genre du joueur en capital] n'arriva à rien ainsi.[otherwise if the French 1PSPa Language option is active]Je n'arrivai à rien comme ça.[otherwise if the French 1PSPr Language option is active]Je n'arrive à rien comme ça.[otherwise]Vous n'arrivez à rien comme ça.[end if]".
...
Carry out talking to:
	if the French 3PSPa Language option is active, say "[genre du joueur en capital] ne sut pas quoi dire";
	if the French 3PSPr Language option is active, say "[genre du joueur en capital] ne sait pas quoi dire.";
	if the French 1PSPa Language option is active, say "Je ne savais pas quoi dire.";
	if the French 1PSPr Language option is active, say "Je ne sais pas quoi dire.";
	if the French Language option is active, say "Vous ne savez pas quoi dire.".
...
Carry out waving hands to:
	say "[if the French 3PSPa Language option is active][genre du joueur en capital] salua [the noun].[otherwise if the French 3PSPr Language option is active][genre du joueur en capital] salue [the noun].[otherwise if the French 1PSPa Language option is active]Je saluai [the noun].[otherwise if the French 1PSPr Language option is active]Je salue [the noun].[otherwise]Vous saluez [the noun].[end if]".
	

Understand "agiter [something]" as waving.
Understand the command "brandir", "secouer" as "agiter".

Understand "montrer [something preferably held] ->/à/a/au/aux [someone]"  as showing it to.  
...
#ifdef FEMALEPLAYER;
    Global CANTGO__TX   = "Elle ne put aller dans cette direction.";
    Global FORMER__TX   = "son ancien elle";
    Global YOURSELF__TX = "elle-même";
...
#ifdef FEMALEPLAYER;
    Global CANTGO__TX   = "Elle ne peut aller dans cette direction."; ! n'est pas utilisé par I7 ??
    Global FORMER__TX   = "son ancien elle";
    Global YOURSELF__TX = "elle-même";
	Constant YOU__TX        = "Elle";
#ifnot;
    Global CANTGO__TX   = "Il ne peut aller dans cette direction."; ! n'est pas utilisé par I7 ??
    Global FORMER__TX   = "son ancien lui";
    Global YOURSELF__TX = "lui-même";
	Constant YOU__TX        = "Il";
#endif;
...
[ DeDuDes obj; ! ex : descendre... sortir...
  if (obj == player) { if (player has female) print "d'elle"; else print "de lui";  return; }
  if (obj has pluralname)  { print "des ", (name) obj; return;}
  if (obj has female or proper) { print "de ", (the) obj; return;} ! ex : de la voiture, de Paris
  !*! test ci-dessous à effectuer avec @output_stream (ZCode) et avec PrintAnyToArray (Glulx) ?
  ! if ((the)obj="l'...") {print "de ", (the) obj; return;} ! ex : de l'avion
...
! Push: see Pull
  ...
  Search: switch (n) {
               ...
               4: if (x1 has animate) "Je savais tenir mes mains tranquilles !";
                  else "Je ne trouvais rien d'intéressant.";
...
!  Blow:           "Il ne peut pas utilement souffler dedans.";
  ...
  Close: switch (n) {
               1: "Il n'est pas possible de fermer cela.";
               2: print (ctheyreorthats) x1, " déjà fermé";
                  if (x1 has female) "e.";
                  ".";
               3: if (player has female) print "Elle"; else print "Il"; " ferme ", (the) x1, ".";
    }
!   CommandsOff: switch (n) {
!         1: "[Enregistrement des commandes désactivé.]";
!         #Ifdef TARGET_GLULX;
...
!         #Endif; ! TARGET_
!     }
  Consult:        if (player has female) print "Elle"; else print "Il";  " ne trouve rien d'intéressant dans ", (the) x1, ".";
  Cut:            "Couper cela ne mène pas à grand-chose.";
!  Dig:            "Creuser ne mene à rien ici.";
  Disrobe: switch (n) {
               1: if (player has female) print "Elle"; else print "Il";  " ne ", (itorthem) x1, " porte pas.";
               2: if (player has female) print "Elle"; else print "Il";  " enlève ", (the) x1, ".";
    }
  ...
  Drop: switch (n) {
               1: if (x1 has pluralname) print (The) x1, " sont ";
                  ...
                  "déjà ici.";
               2: if (player has female) print "Elle"; else print "Il"; " n'a pas ça.";
               
        3:  if (player has female) print "(Elle"; else print "(Il" ; " prend d'abord ", (the) x1, ")^"; say__p = 0; return;
  ...
  Eat: switch (n) {
              1: print_ret (ctheyreorthats) x1,
                  " non-comestible",(s) x1,", selon toute évidence.";
               2: if (player has female) print "Elle"; else print "Il";  " mange ", (the) x1, ". Pas mauvais.";
    }
!   EmptyT: switch (n) {
!                1: print_ret (The) x1, " ne peut rien contenir.";
!                2: print_ret (The) x1, " ", (isorare) x1, " fermé",(es) x1,".";
...
!     }
  Enter: switch (n) {
               1: print "Mais il est déjà ";
                  if (x1 has supporter) print "sur "; else print "dans ";
                  print_ret (the) x1, ".";
               2: if (player has female) print "Elle"; else print "Il";  print " ne peut ";
                  switch (verb_word) {
                      'entrer':    "y entrer.";
                      'asseoir':    "s'y asseoir.";
                      'allonger':    "s'y allonger.";
               ...
               3: if (player has female) print "Elle"; else print "Il"; " ne peut entrer dans ", (the) x1, " fermé",(es) x1,".";
               4: if (player has female) print "Elle"; else print "Il"; print " ne peut ";                  
                  if (x1 has supporter) print "y monter";
                                   else print "y entrer";
                  " si ce n'est pas posé."; 
                               ! sur pieds, non encastré (freestanding)
               5: if (player has female) print "Elle"; else print "Il";
  ...
  Examine: switch (n) {
               1: if (player has female) print "Elle"; else print "Il"; " ne peut rien voir.";
               2: "Rien de particulier concernant ", (the) x1, ".";
               3: print (The) x1, " ", (isorare) x1, " alors ";
                  if (x1 has on) "allumé",(es) x1,"."; else "éteint",(es) x1,".";
                  4:	print (The) actor, " looks closely at ", (the) x1, ".^";  
               5:  if (player has female) print "En dépit de ses efforts, elle"; else print "En dépit de ses efforts, il"; " ne voit rien de particulier dans cette direction.";
    }
  Exit: switch (n) {
              1: "Sortir d'où ?!";
               2: print " ne peut sortir ";
                  print_ret (dedudes) x1, " fermé", (es) x1, ".";
               3: print "Il ";
...
!            }
  ...
  Go: switch (n) {
               1: print "Il doit d'abord ";
                  if (x1 has supporter) print "descendre "; else print "sortir ";
                  print_ret (dedudes) x1, ".";
               2:  if (player has female) print "Elle "; else print "Il "; "ne peut aller par là." ;  
               3: if (player has female) print "Elle "; else print "Il "; "est incapable de gravir ", (the) x1, ".";
               4: if (player has female) print "Elle "; else print "Il "; "est incapable de descendre par ", (the) x1, ".";
               5: if (player has female) print "Elle "; else print "Il "; "en est incapable, puisque ", (the) x1, " ", (isorare) x1,
                  " sur son chemin.";
               6: if (player has female) print "Elle "; else print "Il "; print "en est incapable, puisque ", (the) x1;
                  if (x1 has pluralname) " ne mènent nulle part.";
                  " ne mène nulle part.";
    }
  Insert: switch (n) {
               1: if (player has female) print "Elle"; else print "Il"; " doit avoir en main ", (the) x1,
                  " avant de pouvoir ", (itorthem) x1,
                  " mettre dans autre chose.";
               2: print_ret (Cthatorthose) x1, " ne peut pas contenir d'objet.";
               3: print_ret (The) x1, " ", (isorare) x1, " fermé",(es) x1,".";
               4: if (player has female) print "Elle"; else print "Il"; " a besoin de ", (itorthem) x1, " prendre d'abord.";
               5: "Il n'est pas possible de mettre un objet à l'intérieur de lui-même.";
               6: "(", (itorthem) x1, " prenant d'abord)^";
               7: "Il n'y a plus de place dans ", (the) x1, ".";
               8: "Fait.";
               9: if (player has female) print "Elle"; else print "Il"; " met ", (the) x1, " dans ", (the) second, ".";
    }
  Inv: switch (n) {
               1: if (player has female) print "Elle"; else print "Il"; " n'a rien.";
               2: if (player has female) print "Elle"; else print "Il"; print " a";
        3:  print " :^";
        4:  print ".^";
    }
  Jump:           if (player has female) print "Elle"; else print "Il"; " saute sur place, vainement.";
  ! JumpOver:  if (player has female) print "Elle"; else print "Il"; " n'arrive à rien comme ça.";
  Tie:  if (player has female) print "Elle"; else print "Il"; " n'arrive à rien comme ça.";
  Kiss:           if (player has female) print "Elle"; else print "Il"; " doit plutôt se concentrer sur le jeu.";
  Listen:         if (player has female) print "Elle"; else print "Il"; " n'entend rien de particulier.";
  ListMiscellany: switch (n) {
               1: print " (allumé",(es) x1,")";
               2: print " (qui ", (isorare) x1, " fermé",(es) x1,")";
               3: print " (fermé",(es) x1," et allumé",(es) x1,")";
  ...
  LMode3:         " est passé en mode description courte ; tous les lieux,
                   même non visités, sont décrits brièvement.";
  Lock: switch (n) {
               1: if (player has female) print "Elle"; else print "Il"; " ne peut pas verrouiller cela.";
               2: print_ret (ctheyreorthats) x1, " verrouillé en ce moment.";
               3: if (player has female) print "Elle"; else print "Il"; " doit fermer ", (the) x1, " auparavant.";
               4: "Cela ne rentre pas dans la serrure.";
               5: if (player has female) print "Elle"; else print "Il"; " verrouille ", (the) x1, ".";
    }
  Look: switch (n) {
               1: print " (sur ", (the) x1, ")";
               2: print " (dans ", (the) x1, ")";
        ...
        5,6:
            if (x1 ~= location) {
                if (x1 has supporter) print "^Sur "; else print "^Dans ";
                print (the) x1;
                if (player has female) print " elle"; else print " il"; 
            }
            else if (player has female) print "^Elle"; else print "^Il"; 
            print " peut voir ";
            if (n == 5) print "aussi ";
            WriteListFrom(child(x1),
              ENGLISH_BIT+RECURSE_BIT+PARTINV_BIT+TERSE_BIT+CONCEAL_BIT+WORKFLAG_BIT);
            ".";
        7:  if (player has female) print "Elle"; else print "Il"; " ne voit rien de particulier dans cette direction.";
    }
  LookUnder: switch (n) {
               1: "Mais il fait noir !";
  ...
  Miscellany: switch (n) {
               ...
               2: "Rien à faire !";
               3: print " C'est la fin. ";
               4: if (player has female) print "Elle"; else print "Il"; " a gagné ";
               5: print "^Voulez-vous RECOMMENCER,
                          CHARGER une partie sauvegardée";
                  #IFDEF DEATH_MENTION_UNDO;
                  print ", ANNULER votre dernière action";
            ...
            #Endif; ! TARGET_
              ...
              16: "~Oops~ ne peut corriger qu'un seul mot.";
              17: "L'obscurité est totale.";
              18: if (player has female) print "elle-même"; else print "lui-même" ;
              19: if (player has female) print "Aussi belle"; else print "Aussi beau"; " que d'habitude.";           
              20: "Pour répéter une commande comme ~grenouille, saute~, dîtes seulement
                   ~encore~, et pas ~grenouille, encore~.";
              21: "Impossible.";
              22: "Vous ne pouvez pas commencer une phrase par une virgule.";
              23: "Ses pensées sont confuses.";
              24: if (player has female) print "Elle"; else print "Il"; " ne peut pas discuter avec ", (the) x1, ".";
                  ! "parler à" serait mieux mais délicat (ex: à l'oiseau)
              25: "Pour parler à quelqu'un, essayez ~quelqu'un, bonjour~ ou quelque chose dans le genre.";
!              26: if (player has female) print "(elle"; else print "(il"; " prend d'abord ", (the) not_holding, ")";
              26: if (player has female) print "(elle"; else print "(il"; " prend d'abord cela.)";
              27: "Je ne comprends pas cette phrase.";
!              28: print "Je n'ai compris que : ";
		28: "Merci de reformuler (éventuellement en retirant les articles). Je ne connais que : ";
              29: "Je n'ai pas compris ce nombre.";
              30: if (player has female) print "Elle"; else print "Il"; " ne voit rien de tel, à moins que cela ne soit sans grande importance."; ! Vous ne pouvez voir une telle chose
              31: if (player has female) print "Elle"; else print "Il"; " semble en avoir dit trop peu !";
              32: if (player has female) print "Elle"; else print "Il"; " ne l'a pas en mains !";
              33: "Vous ne pouvez pas employer le mot ~tout~ avec ce verbe.";
              34: "Vous ne pouvez utiliser le mot ~tout~ qu'une fois par ligne."; !*!
              35: "Je ne suis pas certain de ce à quoi ~", (address) pronoun_word,
                  "~ se réfère.";
              36: "Vous avez exclu quelque chose qui n'était de toute façon pas compris dans la liste !";
              37: if (player has female) print "Elle"; else print "Il"; " ne peut faire cela qu'à une chose animée.";
              38: "Je ne connais pas ce verbe.";
              39: "Cela n'a pas la moindre importance.";
              40: if (player has female) print "Elle"; else print "Il"; " ne peut pas voir ~", (address) pronoun_word,
                  "~ (", (the) pronoun_obj, ") à ce moment.";
              41: "Impossible de comprendre la fin de la phrase.";
              42: if (x1==0) print "Aucun de disponible.";
                  else print "Il en reste seulement ", (number) x1, ".";
...
!            }
  Open: switch (n) {
               1: if (player has female) print "Elle"; else print "Il"; " ne peut pas ouvrir cela.";
		2: if (x1 has pluralname) 
			{print (cthatorthose) x1," semble être fermé",(es) x1," à clé.^";} 
			else 
			{print (cthatorthose) x1," semble être fermé",(es) x1," à clé.^";};
...
!                  " être fermé",(es) x1," à clé.";
               3: print (ctheyreorthats) x1, " déjà ouvert";
                  if (x1 has female) "e.";
                  ".";
               4: if (player has female) print "Elle"; else print "Il"; " ouvre ", (the) x1, ", révélant ";
                  if (WriteListFrom(child(x1),
                      ENGLISH_BIT + TERSE_BIT + CONCEAL_BIT)==0) "rien du tout.";
                  ".";
               5: if (player has female) print "Elle"; else print "Il"; " ouvre ", (the) x1, ".";
    }
!   Order:          print (The) x1;
!                   if (x1 has pluralname) print " ont"; else print " a";
!                   " mieux à faire.";
!   Places: switch (n) {
!         1:  print if (player has female) print "Elle"; else print "Il"; " a visité : ";
!         2:  print ".^";
!     }
...
!   Prompt:   print "^>";
  ...
  Pull,Push,Turn: switch (n) {
               1: "C'est fixé sur place.";
               2: if (player has female) print "Elle"; else print "Il"; " en est incapable.";
               3: "Rien d'évident ne se produit.";
...
! Push: see Pull
  PushDir: switch (n) {
               ...
               2: "Ce n'est pas une direction.";
               3: if (player has female) print "Elle"; else print "Il"; " ne peut pas aller dans cette direction.";
    }
  PutOn: switch (n) {
               1: if (player has female) print "Elle"; else print "Il"; " doit avoir en main ", (the) x1,
                  " avant de pouvoir ", (itorthem) x1,
                  " mettre sur quelque chose d'autre.";
               2: if (player has female) print "Elle"; else print "Il"; " ne peut pas poser un objet sur lui-même.";
               3: "Poser des objets sur ", (the) x1, " ne mène à rien.";
               4: if (player has female) print "Elle"; else print "Il"; " manque de dextérité.";
               5: "(", (itorthem) x1, " prenant d'abord)^";
               6: "Il n'y a plus assez de place sur ", (the) x1, ".";
               7: "Cela est fait.";
               8: if (player has female) print "Elle"; else print "Il"; " met ", (the) x1, " sur ", (the) second, ".";
    }
  Quit: switch (n) {
               1: print "Répondez par oui ou par non, je vous prie.";
               2: print "Êtes-vous certain de vouloir quitter ? ";
  ...
  Search: switch (n) {
               ...
               3: print "Sur ", (the) x1, ", il voit "; 
                  WriteListFrom(child(x1),
                      TERSE_BIT + ENGLISH_BIT + CONCEAL_BIT);
                  ".";
               4: if (x1 has animate) "Cette personne ou créature ne se laissera sans doute pas fouiller ainsi !";
                  else if (player has female) print "Elle"; else print "Il";" ne trouve rien d'intéressant.";
               5: if (player has female) print "Elle"; else print "Il"; " ne peut voir à l'intérieur, puisque ", (the) x1, " ",
                  (isorare) x1, " fermé",(es) x1,".";
               6: print_ret (The) x1, " ", (isorare) x1, " vide",(s) x1,".";
               7: print (The) x1;
                  if (x1 has pluralname) print " contiennent ";
...
!  Set:            "Non, il ne peut pas ", (itorthem) x1, " régler.";
  SetTo:          if (player has female) print "Non, elle"; else print "Non, il"; " ne peut pas ", (itorthem) x1, " régler sur rien.";
  Show: switch (n) {
               1: if (player has female) print "Elle"; else print "Il"; " n'a pas ", (the) x1, ".";
               2: print_ret (The) x1, " ", (isorare) x1, " peu impressionné",(es) x1,".";
    }
  Sing:           if (player has female) print "Elle"; else print "Il"; " ne sait pas chanter.";
  Sleep:          if (player has female) print "Elle"; else print "Il"; " n'a pas particulièrement sommeil.";
  Smell:          if (player has female) print "Elle"; else print "Il"; " ne sent rien de particulier.";
  Sorry:          "Faute avouée est à moitié pardonnée.";
  Squeeze: switch (n) {
               1: "Inutile.";
               2: if (player has female) print "Elle"; else print "Il"; " n'arrive à rien ainsi.";
    }
  Strong:         "Les vrais aventuriers n'emploient pas un tel langage.";
...
!  Swim:           "Il n'y a pas assez d'eau pour nager dedans.";  ! swim desactive par defaut dans I7
  ...
  Swing:          "Ce n'est pas une chose à laquelle il est utile de se balancer.";
  SwitchOff: switch (n) {
               1: if (player has female) print "Elle"; else print "Il"; " ne peut pas allumer ou éteindre cela.";
               2: print_ret (ctheyreorthats) x1,
                  " déjà éteint",(es) x1,".";
               3: if (player has female) print "Elle"; else print "Il"; " éteint ", (the) x1, ".";
    }
  SwitchOn: switch (n) {
               1: if (player has female) print "Elle"; else print "Il"; " ne peut pas allumer cela.";
               2: print_ret (ctheyreorthats) x1,
                  " déjà allumé",(es) x1,".";
               3: if (player has female) print "Elle"; else print "Il"; " allume ", (the) x1, ".";
    }
	  Take:    switch(n)
           {   1: "D'accord."; ! ok
               2: if (player has female) print "Elle"; else print "Il"; " est déjà lui-même.";
               3: "Cela ne semble pas être une bonne idée.";
               4: if (player has female) print "Elle"; else print "Il"; print " doit d'abord ";
                  if (x1 has supporter) print "descendre "; else print "sortir ";
                  print_ret (dedudes) x1, ".";
               5: if (player has female) print "Elle"; else print "Il"; " l'a déjà.";
               6: if (noun has pluralname) print "Cela semble ";
                  else print "Cela semble ";
                  "appartenir à ", (the) x1, ".";
               7: if (noun has pluralname) print "Cela semble ";
              ...
              10: "Trop difficile à transporter.";
              11: "C'est fixé sur place.";
              12: if (player has female) print "Elle"; else print "Il"; " transporte déjà trop d'objets.";
              13: if (player has female) print "(elle"; else print "(il"; " met ", (the) x1, " dans ", (the) SACK_OBJECT,
                  " pour faire de la place)";
           }
  Taste:          if (player has female) print "Elle"; else print "Il"; " ne remarque rien de particulier.";
  Tell: switch (n) {
               1: if (player has female) print "Elle discute avec elle-même"; else print "Il discute avec lui-même"; " pendant un moment...";
               2: "Pas de réaction.";
    }
  Think:          "Quelle bonne idée.";
  ThrowAt: switch (n) {
               1: "Futile.";
               2: if (player has female) print "Elle"; else print "Il"; " hésite au moment crucial.";
    }
! Tie:  see JumpOver.
  Touch: switch (n) {
               1: if (player has female) print "Elle"; else print "Il"; " sait tenir ses mains tranquilles !";
               2: if (player has female) print "Elle"; else print "Il"; " ne sent rien de particulier.";
               3: if (player has female) print "Elle"; else print "Il"; " n'y voit aucune utilité.";
    }
! Turn: see Pull.
  Unlock:  switch (n) {
               1: if (player has female) print "Elle"; else print "Il"; " ne peut pas déverrouiller cela.";
               2: print_ret (ctheyreorthats) x1,
                  " déjà déverrouillé", (es) x1, ".";
               3: "Cela ne rentre pas dans la serrure.";
               4: if (player has female) print "Elle"; else print "Il"; " déverrouille ", (the) x1, ".";
    }
!  VagueGo:  "Il fallait donner une direction plus précise.";
  Verify: switch (n) {
               1: "Le fichier semble intact.";
  ...
  Wait:           "Le temps passe...";
  Wake:           if (player has female) print "Elle"; else print "Il"; " ne dort pas.";
  WakeOther:      "Cela ne semble pas nécessaire.";
  Wave: switch (n) {
               1: if (player has female) print "Mais elle"; else print "Mais il"; " n'a pas cela !";
               2: "Inutile.";
    }
  WaveHands:      if (player has female) print "Elle"; else print "Il"; " agite ses mains, sans résultat.";
  Wear: switch (n) {
               1: if (player has female) print "Elle"; else print "Il"; " ne peut pas porter cela !";
               2: if (player has female) print "Elle"; else print "Il"; " n'a pas cela !";
               3: if (player has female) print "Elle"; else print "Il", (itorthem) x1, " porte déjà !";
               4: if (player has female) print "Elle"; else print "Il"; " met ", (the) x1, ".";
    }
! Yes:  see No.
];
...
Notre forum (aide et contact) : http://ifiction.free.fr/taverne
